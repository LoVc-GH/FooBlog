...
using SendGrid;
using FooBlog.Shared.Configuration.Email;
using FooBlog.Shared.Email;
using FooBlog.STS.Identity.Configuration;
using FooBlog.STS.Identity.Configuration.ApplicationParts;
using FooBlog.STS.Identity.Configuration.Constants;
using FooBlog.STS.Identity.Configuration.Interfaces;
using FooBlog.STS.Identity.Helpers.Localization;
using System.Linq;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using FooBlog.Admin.EntityFramework.Shared.Configuration;
using FooBlog.Admin.EntityFramework.SqlServer.Extensions;
using Skoruba.IdentityServer4.Admin.EntityFramework.Helpers;
using Microsoft.AspNetCore.DataProtection.EntityFrameworkCore;
using Microsoft.AspNetCore.Http;
using FooBlog.Shared.Authentication;
using FooBlog.Shared.Configuration.Identity;

namespace FooBlog.STS.Identity.Helpers
{
