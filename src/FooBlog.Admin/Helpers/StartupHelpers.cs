...
using FooBlog.Admin.ExceptionHandling;
using FooBlog.Admin.Configuration;
using FooBlog.Admin.Configuration.ApplicationParts;
using FooBlog.Admin.Configuration.Constants;
...
using FooBlog.Admin.Helpers.Localization;
using System.Linq;
...
namespace FooBlog.Admin.Helpers
{
